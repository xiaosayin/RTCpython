...
def processR(Rout, Rin, recvf, decFrame, completeFrame, renderFrame, allFrame, estimator, packet_record, cc, RL_Pipe):
    ...
    while True:
        ...
        if request:
            ...
            if estimator.state == 'Decrease':
                if active_loss == 1:
                    active_loss = 2
                elif active_loss == 3:
                    active_loss = 1
            elif estimator.state == 'Hold':
                if active_loss == 2:
                    active_loss = 1
            ...
            print("estimator.state:", estimator.state)
            RL_Pipe.send(active_loss)
