...
def plt_reward_record(record_episode_reward, record_episode_reward1, \
        record_episode_reward2, record_episode_reward3, record_episode_reward4, figPath):
    plt.cla()
    ...
    plt.plot(range(len(record_episode_reward3)), record_episode_reward4, alpha = 0.7, label='frameDelay', color = 'purple')
    plt.legend()
    plt.xlabel('Episode')
...
def plt_track(plotTargetT, plotTarget, plotEncT, plotEnc, plotSetT, plotSet, \
            plotTraceT, plotTrace, plotRecvT, plotRecv, mahiT, mahiRate, figPath):
    plt.cla()
...
def plt_reward_track(reward, reward1, reward2, reward3, reward4, figPath):
    plt.cla()
