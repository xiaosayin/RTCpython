...
for i in range(0, len(name)):
    c = colorMap[name[i]]   
    plt.scatter(pkt_delay[i], pkt_recv[i], label = name[i] , marker = markerMap[name[i]], color = c, s = DOT_SIZE, alpha = DOT_ALPHA)
...
for i in range(0, len(name)):
    c = colorMap[name[i]]      
    plt.scatter(pkt_delay[i], pkt_loss[i], label = name[i] , marker = markerMap[name[i]], color = c, s = DOT_SIZE, alpha = DOT_ALPHA)
...
for i in range(0, len(name)):
    c = colorMap[name[i]]      
    plt.scatter(frame_delay[i], frame_psnr[i], label = name[i] , marker = markerMap[name[i]], color = c, s = DOT_SIZE, alpha = DOT_ALPHA)
...
for i in range(0, len(name)):
    c = colorMap[name[i]]    
    plt.scatter(frame_delay[i], frame_loss[i], label = name[i] , marker = markerMap[name[i]], color = c, s = DOT_SIZE, alpha = DOT_ALPHA)
