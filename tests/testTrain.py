...
from test_rtc_env import GymEnv
...
def testTrain(cc, testType, testNum, testQue, testLoss):
    ...
    checkpoint = torch.load(f'tests/{cc}/{cc}.pth')
    ...
    while True :
        ...
        env.reset(testType, testNum, testQue, testLoss)
