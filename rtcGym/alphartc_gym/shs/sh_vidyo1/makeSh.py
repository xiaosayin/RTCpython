portNum = 8001
path = "./rtcGym/alphartc_gym/shs/sh_vidyo1"
while portNum < 8000 + 121:
    ...
    while recv8000Line:
        if "./peerconnection_serverless.origin " not in recv8000Line:
            ...
            newrecvf.write(f"./peerconnection_serverless.origin ./rtcGym/alphartc_gym/jsons/json_vidyo1/sender_pyinfer{portNum}.json\n")
        recv8000Line = recvf8000.readline()
    newrecvf.close()
    recvf8000.close()
    portNum += 1